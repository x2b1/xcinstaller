...
var (
	baseFontSize   float32 = 20
	baseHeaderSize float32 = 40
	btnWidth       float32 = 200
	warningHeight  float32 = 90
)
...
func renderInstaller() g.Widget {
	...
	layout := g.Layout{
		...
		renderErrorCard(
 			DiscordYellow,
 			"**Github** and **Testcord.dev** are the only official places to get Testcord. Any other site claiming to be us is malicious.\n"+
		...
		InfoModal("#scuffed-install", "Hold On!", "You have a broken Discord Install.\n"+
			...
			"You need to fix this before patching, otherwise Testcord will likely not work.\n\n"+
		...
		RawInfoModal("#openasar-confirm", "OpenAsar", "OpenAsar is an open-source alternative of Discord desktop's app.asar.\n"+
			"Testcord is in no way affiliated with OpenAsar.\n"+
