...
func main() {
	...
	var installFlag = flag.Bool("install", false, "Install TestCord")
	var updateFlag = flag.Bool("repair", false, "Repair TestCord")
	var uninstallFlag = flag.Bool("uninstall", false, "Uninstall TestCord")
	...
	if install {
		...
		Log.Info("Downloading latest TestCord files...")
...
func HandleScuffedInstall() {
	...
	fmt.Println("Otherwise, TestCord will likely not work.")
}
